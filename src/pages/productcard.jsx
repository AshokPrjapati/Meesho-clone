...
const Productcard = ({image,price,title,rating}) => {
    ...
    return (
        <div>
            <Box bg={"whitesmoke"} borderRadius={"10px"} h={{base:'50vh',sm:'50vh',lg:'68vh' ,xl:'68vh'}} boxShadow={"rgba(0, 0, 0, 0.16) 0px 1px 4px;"}  padding={"1rem"}>
              ...
              <Flex pl={"1rem"}>
                <div  style={{backgroundColor:x,color:"white",fontStyle:"bold",padding:"0.5rem",borderRadius:"16px",fontWeight:"bold"}}>{rating.rate} ★ </div>
