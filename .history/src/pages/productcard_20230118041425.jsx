...
const Productcard = ({image,price,title,rating}) => {
    ...
    return (
        <div>
            <Box h={"77vh"} boxShadow={"rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;"}  padding={"1rem"}>
              ...
              <Flex pl={"1rem"}>
                <div  style={{backgroundColor:"rgb(244, 182, 25)",color:"white",fontStyle:"bold",padding:"0.5rem",borderRadius:"16px",fontWeight:"bold"}}>{rating} ★ </div>
