    ...
    return (
        <div>
            <Box h={"70vh"} boxShadow={"rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;"}  padding={"1rem"}>
              ...
              <Flex pl={"1rem"}>
                <div  style={{{state?backgroundColor:"rgb(244, 182, 25)":backgroundColor:"green"},color:"white",fontStyle:"bold",padding:"0.5rem",borderRadius:"16px",fontWeight:"bold"}}>3.3 ★ </div>
